...
/* Returns cv::Mat with type CV_32F (= 21, 3 channels) accentuating texture in vertical direction. Values for kernel could need tweaking, current ones are barely more than guesswork. */
